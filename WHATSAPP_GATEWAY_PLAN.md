...
| P1 | Schema multi-tenant + migración a Postgres | Refactor estructural (8.4) | Cloud | ⏳ PENDIENTE | `feature/p1-schema-multitenant` | — | — |
...
**Branch:** `feature/p1-schema-multitenant`
...
git checkout -b feature/p1-schema-multitenant develop
```
...
npm run drizzle:generate -- --check         # no hay drift de schema
...
git push origin feature/p1-schema-multitenant
```
